...
namespace Application.IntegrationTests
{
    public class GetReactionsTests
    {
        ...
        [Fact]
        public void GetReactions_OneSupport_ContinuousLoadConstantOverlaps()
        ...
        [Fact]
        public void GetReactions_OneSupport_ContinuousLoadRisingAtStart()
            => PerformTestForOneSupport([new ContinuousLoad { Value = -1000, Position = 0, Length = 0.6, StartCoefficient = 0, EndCoefficient = 1 }], 300, 120);

        [Fact]
        public void GetReactions_OneSupport_ContinuousLoadRisingAtEnd()
        ...
        [Fact]
        public void GetReactions_TwoSupports_ZeroLoad()
            => PerformTestForTwoSupports([], 0, 0);

        [Fact]
        public void GetReactions_TwoSupports_ForceLoadAtHalf()
            => PerformTestForTwoSupports([new ForceLoad { Value = -1000, Position = 0.6 }], 500, 500);

        [Fact]
        public void GetReactions_TwoSupports_ForceLoadUnbalanced()
            => PerformTestForTwoSupports([new ForceLoad { Value = -1000, Position = 0.35 }], 750, 250);

        [Fact]
        public void GetReactions_TwoSupports_ForceLoadsAtEdges()
        {
            List<Load> loads =
            [
        ...
        [Fact]
        public void GetReactions_TwoSupports_MomentLoad()
            => PerformTestForTwoSupports([new MomentLoad { Value = 2000, Position = 0.4 }], 2000, -2000);

        [Fact]
        public void GetReactions_TwoSupports_ContinuousLoadConstantThrough()
        ...
        [Fact]
        public void GetReactions_TwoSupports_ContinuousLoadConstantAtStart()
            => PerformTestForTwoSupports([new ContinuousLoad { Value = -1000, Position = 0, Length = 0.4, StartCoefficient = 1, EndCoefficient = 1 }], 360, 40);

        [Fact]
        public void GetReactions_TwoSupports_ContinuousLoadConstantAtMiddle()
        ...
        [Fact]
        public void GetReactions_TwoSupports_ContinuousLoadConstantAtEnd()
        ...
        [Fact]
        public void GetReactions_TwoSupports_ContinuousLoadRisingThrough()
        ...
        [Fact]
        public void GetReactions_TwoSupports_ContinuousLoadFallingThrough()
        ...
        [Fact]
        public void GetReactions_TwoSupports_ManyLoads()
        {
            List<Load> loads =
            [
                new ForceLoad { Value = -2000, Position = 0 },
